...
const PricingBox = (props: {
  ...
  return (
    <div className="m1" style={{margin: '1rem'}}>
      <div
      ...
      >
        ...
        <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 dark:border-white dark:border-opacity-10">
          <Link href='/workshops' className="btn btn-gradient-secondary w100 centerResponsiveButton mt05 flex" style={{justifyContent: 'center'}}>
              <p className="mr1" style={{color: '#3662E3', top: '-.2rem', position: 'relative', fontSize: '1.1rem'}}>Empezar gratis
              </p>
