...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 27987)), "C:\\Users\\barto\\OneDrive\\Desktop\\stockeado\\stockeado-mvp\\app\\quotes\\page.tsx"],
          
        }]
      },
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 17719)), "C:\\Users\\barto\\OneDrive\\Desktop\\stockeado\\stockeado-mvp\\app\\quotes\\layout.tsx"],
...
const pages = ["C:\\Users\\barto\\OneDrive\\Desktop\\stockeado\\stockeado-mvp\\app\\quotes\\page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/quotes/page";
const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5012))
...
/* harmony import */ var _table_library_react_table_library_compact__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(77761);
...
/* harmony import */ var _table_library_react_table_library_pagination__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(17252);
...
/* harmony import */ var _table_library_react_table_library_theme__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1077);
/* harmony import */ var _table_library_react_table_library_baseline__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(35655);
/* harmony import */ var _orders_index_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(88677);
/* harmony import */ var _orders_index_css__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_orders_index_css__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _api_quotess_call__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(94);
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(57296);
...
const QuoutesLayoutPage = ()=>{
    ...
    const pagination = (0,_table_library_react_table_library_pagination__WEBPACK_IMPORTED_MODULE_6__/* .usePagination */ .h)({
        nodes: ordersData ?? []
    }, {
        state: {
            page: 0,
    ...
    const COLUMNS = [
        ...
        },
        {
            ...
            renderCell: (item)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                    style: {
                        color: geTexttColor(item)
                    },
                    children: getTextState(item)
                })
        },
        {
            label: "",
            renderCell: (item)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_reacticons_ionicons__WEBPACK_IMPORTED_MODULE_7___default()), {
                            onClick: async ()=>{
                                const response = await (0,_api_quotess_call__WEBPACK_IMPORTED_MODULE_11__/* .deleteQuote */ .UO)(item?._id);
    ...
    const toUser = async ()=>{
        const userr = await (0,_api_userr_call__WEBPACK_IMPORTED_MODULE_5__/* .getUser */ .PR)();
                ...
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                                        ...
                                        onClick: ()=>router.push("/createquote"),
                                        style: {
                                            fontSize: ".8rem",
                                            borderRadius: ".5rem",
                                            padding: ".2rem",
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_table_library_react_table_library_compact__WEBPACK_IMPORTED_MODULE_2__/* .CompactTable */ ._, {
                                theme: theme,
                                layout: {
                                    custom: true,
                                ...
                                columns: COLUMNS,
                                data: {
                                    nodes: ordersData?.filter((item)=>item?.vehicle.toLowerCase().includes(search.toLowerCase()))
                                }
                            }),
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                style: {
                                ...
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                                        ...
                                        children: [
                                            "Paginas: ",
                                            pagination.state.getTotalPages(ordersData ?? [])
                                        ]
                                    }),
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                                        children: [
                                            "Actual:",
                                            "  ",
                                            pagination.state.getPages(ordersData ?? []).map((_, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", {
                                                    type: "button",
                                                    style: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (QuoutesLayoutPage);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\barto\OneDrive\Desktop\stockeado\stockeado-mvp\app\quotes\layout.tsx`)
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56786);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17719);
