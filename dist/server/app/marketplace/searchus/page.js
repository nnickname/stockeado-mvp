...
const LayoutMarketPlaceFindItem = ()=>{
    ...
    const filterByBrand = (brand, checked)=>{
        if (checked) setItems(realItems.filter((item)=>item.brand === brand));
    };
...
var __webpack_exports__ = __webpack_require__.X(0, [8478,964,954,4185,9816,4997,3800,5827,5645,4328,507,1142,8316,7445], () => (__webpack_exec__(29634)));
