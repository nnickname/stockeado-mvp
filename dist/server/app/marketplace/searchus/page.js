...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7664)), "C:\\Users\\barto\\OneDrive\\Desktop\\stockeado\\stockeado-mvp\\app\\marketplace\\searchus\\page.tsx"],
...
const pages = ["C:\\Users\\barto\\OneDrive\\Desktop\\stockeado\\stockeado-mvp\\app\\marketplace\\searchus\\page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/marketplace/searchus/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/marketplace/searchus/page",
        pathname: "/marketplace/searchus",
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 75452))
...
/* harmony import */ var _api_marketplacee_call__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(53315);
/* harmony import */ var _components_marketplace_item__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(34884);
...
const LayoutMarketPlaceFindItem = ()=>{
    ...
    const filterByBrand = (brand, checked)=>{
        if (checked) setItems(realItems.filter((item)=>Number(item.brand === brand)));
    };
    const filterByType = (type, checked)=>{
        if (checked) setItems(realItems.filter((item)=>Number(item.type === type)));
    };
    const filterByCategorie = (categorie, checked)=>{
        if (checked) setItems(realItems.filter((item)=>Number(item.categorie === categorie)));
    };
    ...
    const findProductAndSet = async ()=>{
        if (keywordFind?.length > 1) {
            const response = await (0,_api_marketplacee_call__WEBPACK_IMPORTED_MODULE_6__/* .findProduct */ .V_)(keywordFind);
            setItems(response ?? []);
        } else setItems(realItems ?? []);
    };
    const [isPopoverOpenBrand, setPopoverOpenBrand] = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(false);
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        children: items === null ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_reacticons_ionicons__WEBPACK_IMPORTED_MODULE_9___default()), {
                                    ...
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("input", {
                                                ...
                                                type: "text",
                                                name: "email",
                                                placeholder: "Buscar por n\xfamero de parte",
                                                value: keywordFind ?? ""
                                            })
                                        }),
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            ...
                            children: [
                                ...
                                items?.length > 0 ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            className: "gridItems",
                                            children: items?.slice(currentPage * postPerPage - postPerPage, currentPage * postPerPage).map((e, index)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_marketplace_item__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, {
                                                    item: e,
                                                    setCart: setCart,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LayoutMarketPlaceFindItem);
...
;// CONCATENATED MODULE: ./app/marketplace/searchus/layoutsearch.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\barto\OneDrive\Desktop\stockeado\stockeado-mvp\app\marketplace\searchus\layoutsearch.tsx`)
...
const Page = ()=>{
    return /*#__PURE__*/ jsx_runtime_.jsx(layoutsearch, {});
};
...
var __webpack_exports__ = __webpack_require__.X(0, [8478,964,954,4185,9816,4997,3800,9636,4328,507,1142,8316,7445], () => (__webpack_exec__(29634)));
