...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 17141)), "C:\\Users\\barto\\OneDrive\\Desktop\\stockeado\\stockeado-mvp\\app\\configuration\\page.tsx"],
          
        }]
      },
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 73229)), "C:\\Users\\barto\\OneDrive\\Desktop\\stockeado\\stockeado-mvp\\app\\configuration\\layout.tsx"],
...
const pages = ["C:\\Users\\barto\\OneDrive\\Desktop\\stockeado\\stockeado-mvp\\app\\configuration\\page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/configuration/page";
const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 85026))
...
const LayoutConfigurationPage = ()=>{
    ...
    const [image, setImage] = (0,react_experimental_.useState)(null);
    const [imageLogo, setImageLogo] = (0,react_experimental_.useState)(null);
    const [direction, setDirection] = (0,react_experimental_.useState)(null);
    const [name, setName] = (0,react_experimental_.useState)(null);
    const [lastName, setLastname] = (0,react_experimental_.useState)(null);
    const [phone, setPhone] = (0,react_experimental_.useState)(null);
    const [nameShop, setNameShop] = (0,react_experimental_.useState)(null);
    const toUser = async ()=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        children: user === null ? /*#__PURE__*/ jsx_runtime_.jsx((IonIcon_default()), {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                ...
                                children: /*#__PURE__*/ jsx_runtime_.jsx("input", {
                                    ...
                                    placeholder: "Nombre de tienda (" + user?.nameShop + ")",
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx("input", {
                                        ...
                                        placeholder: "Apellido (" + user?.lastname + ")",
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("input", {
                                        ...
                                        placeholder: "Direcci\xf3n (" + user?.direction + ")",
                                        className: "border-stroke dark:text-body-color-dark dark:shadow-two  w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none",
                                        style: {
                                            background: "transparent"
                                        }
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx("input", {
                                        ...
                                        placeholder: "Whatsapp (" + user?.phone + ")",
                                        className: "border-stroke dark:text-body-color-dark dark:shadow-two w-full rounded-sm border  px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none",
                                        style: {
                                            background: "transparent"
                                        }
...
/* harmony default export */ const layout = (LayoutConfigurationPage);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\barto\OneDrive\Desktop\stockeado\stockeado-mvp\app\configuration\layout.tsx`)
...
/* harmony import */ var _layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(73229);


const metadata = {
    title: "Stockeado - Configuraci\xf3n",
...
var __webpack_exports__ = __webpack_require__.X(0, [8478,964,4185,4997,9816,8284,2113,4328,4939,8088], () => (__webpack_exec__(74792)));
