...
const loginUser = async (email, password)=>{
    try {
        ...
        const response = await _call__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.post("/user/login", {
            email,
            password
        });
...
const getUserById = async (id)=>{
    try {
        const response = await _call__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.get("/user/login", {
            headers: {
                "token": id
            }
        });
...
const getUser = async ()=>{
    try {
        ...
        const response = await _call__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.get("/user", {
            headers: {
                "token": token
            }
        });
...
const editUser = async (body)=>{
    try {
        const response = await _call__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.post("/user/edit", {
            ...body
        });
        if (response?.data?.user !== undefined) {
            return true;
...
const createUser = async (body)=>{
    try {
        const response = await _call__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.post("/user/edit/create", {
            ...body
        });
        if (response?.data?.user !== undefined) {
            return true;
